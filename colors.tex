...
%\def\color{\@ifnextchar[ {\_color_coded\_color_set}{\_color_defined\_color_set}}
...
\def\color{\@ifnextchar[ {\_color_coded}{\_color_defined}}

\def\definecolor#1#2#3{\@xp\def\csname c@#1\endcsname{{#2}{#3}}}
